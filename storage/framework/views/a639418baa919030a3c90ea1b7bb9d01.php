                        ...
                        <div class="nav-user-dropdown">
                            ...
                            <div class="user-dropdown-menu" id="userDropdownMenu">
                                <div class="dropdown-header">
                                    <div class="dropdown-user-info">
                                        ...
                                        <div class="user-details">
                                            ...
                                            <span class="user-role"><?php echo e(Auth::user()->role === 'admin' ? 'Quản trị viên' : (Auth::user()->role === 'staff' ? 'Nhân viên' : 'Khách hàng')); ?></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul class="dropdown-items">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('order.history')); ?>" class="dropdown-item">
