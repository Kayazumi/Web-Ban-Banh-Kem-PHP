...
.hero {
    position: relative;
    background-image: url("<?php echo e(asset('images/banh.jpg')); ?>");
    ...
    <div class="container">
        <div class="welcome-content">
            <div class="welcome-images">
                <img src="<?php echo e(asset('images/chaomung1.jpg')); ?>" alt="La Cuisine Ngọt - Artisan Baking" class="welcome-img-1">
                <img src="<?php echo e(asset('images/chaomung2.jpg')); ?>" alt="La Cuisine Ngọt - Quality Products" class="welcome-img-2">
            </div>
    ...
    <div class="container">
        <div class="vision-mission-grid">
            ...
            <div class="vm-item vm-image">
                <img src="<?php echo e(asset('images/sumenh.jpg')); ?>" alt="Sứ mệnh La Cuisine Ngọt">
            </div>
